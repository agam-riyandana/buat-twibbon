...
export default function Banner() {
  ...
  const description = `Stand for humanity! Palestine has a right to defend itself. Together, we can put an end to the Gaza and Rafah genocide. Let's unite to #SAVEGAZA #SAVERAFAH and ensure that every life in this region has access to the most basic necessities.`;
